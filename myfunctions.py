...
print("pow_many", pow_many(1, 1, 2) == 3)  # True -> (1 + 2)**1 == 3
print("pow_many", pow_many(1, 2, 3) == 5)  # True -> (2 + 3)**1 == 5
print("pow_many", pow_many(2, 1, 1) == 4)  # True -> (1 + 1)**2 == 4
print("pow_many", pow_many(3, 2) == 8)  # True -> 2**3 == 8
print("pow_many", pow_many(2, 1, 2, 3, 4) == 100)  # True -> (1 + 2 + 3 + 4)**2 == 10**2 == 100
...
print("my_filter", my_filter([1, 2, 3, 4, 5], lambda x: x > 3) == [4, 5])  # True
print("my_filter", my_filter([1, 2, 3, 4, 5], lambda x: x == 2) == [2])  # True
print("my_filter", my_filter([1, 2, 3, 4, 5], lambda x: x != 3) == [1, 2, 4, 5])  # True
print("my_filter", my_filter(['a', 'b', 'c', 'd'], lambda x: x in 'abba') == ['a', 'b'])  # True
